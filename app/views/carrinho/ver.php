<div class="center">
  ...
  <div class="card">
    ...
    <?php if (empty($itens)): ?>
      ...
      <strong> <a href="/">Veja o cardápio</a>
      </strong>
    <?php else: ?>
      <table class="table">
        <tr>
        ...
        <?php foreach ($itens as $item): ?>
          <tr>
            <td>
              <p><?= htmlspecialchars($item['nome']) ?></p><br>
            </td>
            <td>
              <form class="js-form-quantidade flex-row" method="post" action="/?r=carrinho/atualizar">
                ...
                <input class="input js-quantidade w-80" name="quantidade" type="number" min="0"
            ...
            <td>
              <span class="js-subtotal" id="subtotal-<?= (int) $item['prato_id'] ?>"
...
<?php if (!empty($itens)): ?>
  <div class="card">
    ...
    <form method="post" action="/?r=carrinho/finalizar">
      ...
      <select name="tipo_entrega" class="input" required onchange="
